...
{
    public:
        Atelier(int pinStopPower, unsigned long inactivityDelay, int pinsAlarm[6], int pinsLight[3], int pinsLightBtn[2], int pinsFence[2], TimeRange *lunch, TimeRange *night);
    ...
    private:
        int _pinStopPower;
        unsigned long _inactivityDelay;
